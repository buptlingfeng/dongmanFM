 ...
 */
public class GroupClassicFragment extends BaseFragment{

    private static final String TAG = GroupClassicFragment.class.getSimpleName();
    ...
    public class ClassicAdapter extends RecyclerView.Adapter<ClassicAdapter.CommunityViewHolder>{
        ...
        public CommunityViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View view = mInflater.inflate(R.layout.community_hot_spot_topic_item, null, false);
