 ...
 * 其中的内容包括：漫贴、盘点、情报三方面内容的融合
 */
public class RecommendNewsFragmet extends BaseFragment {

    private static final String TAG = RecommendNewsFragmet.class.getSimpleName();
