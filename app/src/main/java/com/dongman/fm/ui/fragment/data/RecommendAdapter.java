 ...
 */
public class RecommendAdapter extends RecyclerView.Adapter<RecommendAdapter.SimpleViewHolder> {
    ...
    public RecommendAdapter addData(RecommendData data,int index) {
    ...
    public RecommendAdapter removeData(int index) {
        mDatas.remove(index);
