...
public class RecycleBin {
	 ...
	 * at the start of layout, and at the end of layout all com.dongman.fm.ui.view in activeViews
	 * are moved to scrapViews. Views in activeViews represent a contiguous
	 * range of Views, with position of the first com.dongman.fm.ui.view store in
	 * mFirstActivePosition.
	 */
	private View[] activeViews = new View[0];
	private int[] activeViewTypes = new int[0];

	/** Unsorted views that can be used by the adapter as a convert com.dongman.fm.ui.view. */
	...
	/** @return A com.dongman.fm.ui.view from the ScrapViews collection. These are unordered. */
	...
	/**
	 * Put a com.dongman.fm.ui.view into the ScrapViews list. These views are unordered.
	 * 
	 * @param scrap
	 *            The com.dongman.fm.ui.view to add
	 */
	@SuppressLint("NewApi")
	...
	static View retrieveFromScrap(SparseArray<View> scrapViews, int position) {
		...
		if (size > 0) {
			// See if we still have a com.dongman.fm.ui.view for this position.
