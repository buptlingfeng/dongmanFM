 ...
 */
public class GroupShowFragment extends BaseFragment{

    private static final String TAG = GroupShowFragment.class.getSimpleName();
    ...
    public class ClassicAdapter extends RecyclerView.Adapter<ClassicAdapter.CommunityViewHolder>{
        ...
        public CommunityViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View view = mInflater.inflate(R.layout.state_image_item, null, false);
