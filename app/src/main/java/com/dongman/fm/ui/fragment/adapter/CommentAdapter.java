...
public class CommentAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.dividerLine = convertView.findViewById(R.id.divider_line);
...
//            commentData.commentId = object.getString("id");
            commentData.avatar = object.getString("avatar_url");
            commentData.content = object.getString("content");
            commentData.userNick = object.getString("user_name");
            commentData.date = object.getString("create_time");
            return commentData;
        } catch (JSONException e) {
            e.printStackTrace();
        }
    ...
    public static JSONObject createData() {
        try {
            ...
            object.put("avatar_url","http://animes-public.stor.sinaapp.com/Uploads/556aeb1ee5099.jpg");
            object.put("user_name", "小明");
            object.put("content","观看请注意：前方高能！！！！");
            object.put("create_time","2015-07-31");
