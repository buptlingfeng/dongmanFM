package com.dongman.fm.ui.view.viewpager;
 ...
 * with com.dongman.fm.ui.view types and com.dongman.fm.ui.view recycling.
 */
public abstract class RecyclingPagerAdapter extends PagerAdapter {
	 ...
	 *            com.dongman.fm.ui.view type we want.
	 ...
	 * to specify a root com.dongman.fm.ui.view and to prevent attachment to the root.
	 * 
	 * @param position
	 *            The position of the item within the adapter's data set of the
	 *            item whose com.dongman.fm.ui.view we want.
	 * @param convertView
	 *            The old com.dongman.fm.ui.view to reuse, if possible. Note: You should check
	 *            that this com.dongman.fm.ui.view is non-null and of an appropriate type before
	 *            using. If it is not possible to convert this com.dongman.fm.ui.view to display
	 *            the correct data, this method can create a new com.dongman.fm.ui.view.
	 *            Heterogeneous lists can specify their number of com.dongman.fm.ui.view types, so
	 *            that this View is always of the right type (see
	 *            {@link #getViewTypeCount()} and {@link #getItemViewType(int)}
	 *            ).
	 * @param parent
	 *            The parent that this com.dongman.fm.ui.view will eventually be attached to
