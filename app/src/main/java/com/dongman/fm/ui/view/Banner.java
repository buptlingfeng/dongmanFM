...
import com.dongman.fm.ui.utils.HandlerTimer;
...
public class Banner extends FrameLayout{
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        initView(LayoutInflater.from(this.getContext()).inflate(R.layout.banner, this));
    }

    private void initAttr(Context context, AttributeSet attrs, int defStyle) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Banner, defStyle, 0);
        if (a != null) {
            mScrollInterval = a.getInt(R.styleable.Banner_uik_autoScrollInterval, DEFAULT_CYCLE_INTERVAL_MILLS);
            mAutoScroll = a.getBoolean(R.styleable.Banner_uik_autoScroll, false);
    ...
    private void initView(View root) {
        ...
        mViewPager.setOnPageChangeListener(new LoopViewPager.OnPageChangeListener() {
